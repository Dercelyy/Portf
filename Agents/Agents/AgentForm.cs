...
namespace Agents
{
    public partial class AgentForm : MaterialForm
    {
        ...
        private void LoadData()
        {
            ...
            dataAdapter = new SqlDataAdapter(" SELECT idAgent, FirstNameA as 'Фамилия', MiddleName as 'Имя', LastName as 'Отчество', Phone as 'Телефон' FROM agents", dataBaseConnection);
            dataAdapter.Fill(ds, "agents");
            DT = ds.Tables["agents"];
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand createUser = new SqlCommand("INSERT INTO agents (FirstNameA, MiddleName, LastName, Phone)VALUES(@FirstNameA, @MiddleName, @LastName, @Phone)", sqlConnection);
                sqlConnection.Open();
                createUser.Parameters.AddWithValue("FirstNameA", FBox.Text);
        ...
        {
            string sql = "UPDATE agents SET FirstNameA='" + MainTable[1, MainTable.SelectedCells[0].RowIndex].Value.ToString() + "', MiddleName ='" + MainTable[2, MainTable.SelectedCells[0].RowIndex].Value.ToString()+ "', LastName ='" + MainTable[3, MainTable.SelectedCells[0].RowIndex].Value.ToString() + "', Phone ='" + MainTable[4, MainTable.SelectedCells[0].RowIndex].Value.ToString()
              + "' WHERE idAgent='" + MainTable[0, MainTable.SelectedCells[0].RowIndex].Value.ToString() + "'"; ;
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string commTextt = "delete from agents where idAgent = @idAgent";
                myConnection.Open();
                ...
                commt.Parameters.AddWithValue("@idAgent", MainTable[0, MainTable.CurrentRow.Index].Value);
                try
                {
