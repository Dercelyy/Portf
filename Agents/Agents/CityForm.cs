...
namespace Agents
{
    public partial class CityForm : MaterialForm
    {
        ...
        private void LoadData()
        {
            ...
            dataAdapter = new SqlDataAdapter(" SELECT idCity, NameСity as 'Город' FROM city", dataBaseConnection);
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand createUser = new SqlCommand("INSERT INTO city (NameСity)VALUES(@NameСity)", sqlConnection);
                sqlConnection.Open();
                createUser.Parameters.AddWithValue("NameСity", CityBox.Text);
        ...
        {
            string sql = "UPDATE city SET NameСity='" + MainTable[1, MainTable.SelectedCells[0].RowIndex].Value.ToString()
