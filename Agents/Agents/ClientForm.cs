...
namespace Agents
{
    public partial class ClientForm : MaterialForm
    {
        ...
        private void LoadData()
        {
            ...
            dataAdapter = new SqlDataAdapter(" SELECT idClient, FirstName as 'Фамилия', MiddleName as 'Имя', LastName as 'Отчество', Phone as 'Телефон' FROM clients", dataBaseConnection);
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand createUser = new SqlCommand("INSERT INTO clients (FirstName, MiddleName, LastName, Phone)VALUES(@FirstName, @MiddleName, @LastName, @Phone)", sqlConnection);
                sqlConnection.Open();
                createUser.Parameters.AddWithValue("FirstName", FBox.Text);
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string commTextt = "delete from clients where idClient = @idClient";
                myConnection.Open();
                ...
                commt.Parameters.AddWithValue("@idClient", MainTable[0, MainTable.CurrentRow.Index].Value);
                try
                {
